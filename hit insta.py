...
-𝗗𝗮𝘁𝗲 : {date(Id)}
-𝗣𝗿𝗶𝘃𝗮𝘁𝗲 :{is_private}
-𝗶𝗻𝗙𝗼 : https://www.instagram.com/{username}?igsh=bXRmcXUyMXVxM3Mx
-𝗕𝗜𝗢 : {bio}
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
Dev : @PYHDR
...
Dev : @PYHDR
        ...
        requests.post(f"https://api.telegram.org/bot{tok}/sendMessage",
              params={'chat_id': iid, 'text': f"<b>{ff}</b>", 'parse_mode': 'HTML'})
...
def gmail(email):
    ...
    if 'password' in response:
        info(email)
        ge+=1
        sys.stdout.write(f'''\r< ¦{F}True : {M}{ge}{Z} | False: {M}{bi}{X} | Good iN: {M}{be}{C} | NOT: {M}{gi}¦ >'''),sys.stdout.flush()
    else:
        be+=1
        sys.stdout.write(f'''\r< ¦{F}True : {M}{ge}{Z} | False: {M}{bi}{X} | Good iN: {M}{be}{C} | NOT: {M}{gi}¦ >'''),sys.stdout.flush()
...
'abcdefghijklmnopqrstuvwxyzéèêëàâäôùûüîïç',                'abcdefghijklmnopqrstuvwxyzñ',
        ...
        headers = {
            ...
            # 'cookie': 'dpr=1.25; datr=6O7kZgu1ulLf5gK95GchZRET; ig_did=B43F5A2E-7A93-4937-9E65-4BC84C89DA94; mid=ZuTu6QALAAHeXMTgeVtLhPvF0Cr7; ig_nrcb=1; ps_l=1; ps_n=1; fbm_124024574287414=base_domain=.instagram.com; csrftoken=mf3zd6qWxnKgh9BaNRI5Ldpms2NrH62X; ds_user_id=67838469205; sessionid=67838469205%3ASpNRbrxNQXWckx%3A14%3AAYd2Mc11qYE8kqvKQNrse5VPplyqdMnvzE92NlPDGg; fbsr_124024574287414=DdIgVPj5Zep-bBC69k0IKcM5Z_9TusSjLSidMZDqWRA.; rur="LDC\\05467838469205\\0541758153066:01f72be7578ed09a57bfe3e41c19af58848e0e965e0549f6d1f5a0168a652d2bfa28cd9a"; wd=783x730',
        ...
        try:
            ...
            for Hus in response:
                pyhdr = Hus['user']['username']
                email=pyhdr+"@gmail.com"
                insta(email)
        except:
            continue
def ee(name):
...
def haider():
 ...
 #-----------------------------------------------
 [1] - Check ListUser Gmail - فحص لستة جيميل
 [2] - Check ListUser Hotmail - فحص لستة هوتميل
 [3] - Random Gmail - عشوائي جيميل
 #-----------------------------------------------
      """
   print(hh)
   try:
       i = int(input(f' Choose [اختار] : '))
       if i ==1:
        name=input(S+" File Name [اسم الكومبو] : ")
        os.system('cls'if os.name=='nt'else'clear')
        ee(name)
       elif i==2:
          name=input(S+" File Name [اسم الكومبو] : ")
          ...
          os.system('cls'if os.name=='nt'else'clear')
          from threading import Thread as kk
          for i in range(80):
             kk(target=random1).start()
